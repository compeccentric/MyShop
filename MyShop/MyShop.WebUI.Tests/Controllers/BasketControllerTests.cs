...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "seth.broder@gmail.com", ZipCode = "33498" });

            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("seth.broder@gmail.com", "Forms" ), null);
